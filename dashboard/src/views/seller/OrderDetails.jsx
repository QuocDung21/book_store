...
import {paymentStatus} from "../../utils/default";
...
const ChiTietDonHang = () => {
    ...
    useEffect(() => {
        setTrangThai(order?.delivery_status);
    }, [order]);

    const capNhatTrangThai = (e) => {
        dispatch(
                            ...
                            <div className="pr-3 text-[#d0d2d6] text-lg">
                                <div className="flex flex-col gap-1">
                                    <h2 className="pb-2 font-semibold">
                                        Giao Hàng Đến : {order.shippingInfo}
                                    </h2>
                                </div>
