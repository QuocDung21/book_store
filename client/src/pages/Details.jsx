...
const Details = () => {
  ...
  return (
    <div>
      <Headers />
      <div className='bg-[url("http://localhost:3000/images/banner/2.jpg")] h-[410px] mt-6 bg-cover bg-no-repeat relative bg-left'>
        <div className="absolute left-0 top-0 w-full h-full bg-[#2422228a]">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex flex-col justify-center gap-1 items-center h-full w-full text-white">
              <h2 className="text-3xl font-bold">Play book</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <section>
        <div className="w-[65%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16">
          <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex justify-start items-center gap-4">
                ...
                <span className="text-black">({} đánh giá)</span>
              </div>
                ...
                {product.stock ? (
                  <>
                    ...
                    <div>
                      <button
                        onClick={add_card}
                        className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-purple-500/40 bg-bg_df_ text-white"
                      >
                        Thêm vào giỏ hàng
                      </button>
                    </div>
              ...
              <div className="flex  py-5 gap-4 border-b">
                ...
                <div className="w-[350px] text-gray text-lg flex flex-col gap-5 ">
                  <span
                  ...
                  <span className="">{product.nam_nxb}</span>
                  <span>{product.sotrang} Trang</span>
                  <span>{product.trongluong} Gram</span>
                  <span>{product.loaibia}</span>
                </div>
              </div>
              <div className="flex gap-3">
                {product.stock ? (
                  <button
                    onClick={buy}
                    className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-emerald-500/40 bg-bg_df_ text-white"
                  >
                    Mua ngay
                  </button>
                ) : (
                ...
                <Link
                  ...
                  className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-lime-500/40 bg-bg_df_ text-white block"
                >
      ...
      <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16">
          <div className="flex flex-wrap">
              ...
              <div className="pr-4 md-lg:pr-0">
                <div className="grid grid-cols-2">
                  <button
                    ...
                    className={`py-1 hover:text-white px-5 hover:bg-bg_df_ ${
                      state === "reviews"
                        ? "bg-bg_df_ text-white"
                  ...
                  <button
                    ...
                    className={`py-1 px-5 hover:text-white hover:bg-bg_df_ ${
                      state === "description"
                        ? "bg-bg_df_ text-white"
                        : "bg-slate-200 text-slate-700"
                    } rounded-sm`}
            ...
            <div className="w-[16%] md-lg:w-full">
              <div className="pl-4 md-lg:pl-0">
                <div className="px-3 py-2 text-slate-600 bg-slate-200">
                  <h2> Sản phẩm của {product.shopName}</h2>
                </div>
                <div className="flex flex-col gap-5 mt-3 border p-3 justify-center items-center">
      ...
      <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          <h2 className="text-2xl py-8 text-slate-600">Sách tương tự</h2>
          <div>
            <Swiper
              slidesPerView="auto"
              breakpoints={{
