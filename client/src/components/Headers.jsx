                ...
                <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                  ...
                  <li>
                    <Link
                      to="/shops"
                      className={`p-2 block ${
                        pathname === "/shops" ? "text-t_df_" : "text-slate-600"
                      }`}
                    >
                      Sản phẩm
                    </Link>
          ...
          <div className="flex justify-start flex-col gap-6">
            ...
            <ul className="flex flex-col justify-start items-start  text-md font-semibold uppercase">
              ...
              <li>
                <Link
                  className={`py-2 block ${
                    pathname === "/shop" ? "text-t_df_" : "text-slate-600"
                  }`}
                >
                  Shop
                </Link>
              ...
              <li>
                <Link
                  className={`py-2 block ${
                    pathname === "/about" ? "text-t_df_" : "text-slate-600"
                  }`}
                >
                  About
                </Link>
              ...
              <li>
                <Link
                  className={`py-2 block ${
                    pathname === "/contact" ? "text-t_df_" : "text-slate-600"
                  }`}
                >
                  Contact
                </Link>
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              <div
                ...
                className="h-[50px] bg-bg_df_ text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
              >
            ...
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
              <div className="w-8/12 md-lg:w-full">
                <div className="flex border h-[50px] items-center relative gap-5">
                  ...
                  <button
                    onClick={search}
                    className="bg-bg_df_ right-0 absolute px-8 h-full font-semibold uppercase text-white"
                  >
                    Tìm
                  </button>
                </div>
