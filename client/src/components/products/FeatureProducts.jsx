...
const FeatureProducts = ({ products }) => {
  ...
  return (
    <div className="w-[85%] flex flex-wrap mx-auto">
      ...
      <div className="w-full grid grid-cols-8 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-1">
        {products.map((p, i) => (
          <div
            key={i}
